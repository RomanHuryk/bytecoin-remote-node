...
const size_t   P2P_DEFAULT_WHITELIST_CONNECTIONS_PERCENT     = 20;
const uint32_t P2P_DEFAULT_HANDSHAKE_INTERVAL                = 60;            // seconds
const uint32_t P2P_DEFAULT_PACKET_MAX_SIZE                   = 50000000;      // 50000000 bytes maximum packet size
const uint32_t P2P_DEFAULT_PEERS_IN_HANDSHAKE                = 250;
const uint32_t P2P_DEFAULT_CONNECTION_TIMEOUT                = 30000;          // 30 seconds
const uint32_t P2P_DEFAULT_PING_CONNECTION_TIMEOUT           = 10000;          // 10 seconds
const uint64_t P2P_DEFAULT_INVOKE_TIMEOUT                    = 60 * 4 * 1000; // 4 minutes
